...
define([
  ...
  graphicsUtils, NlsStrings,  esriRequest, Dialog) {
...
//Dialog to hold metadata from rest endpoint
  ...
  var clazz = declare([], {
    ...
    _getATagLabel: function() {
      ...
      //removed the href
      return '<a class="menu-item-description" id="'+ url + '" target="_blank">' + label + '</a>';
    ...
    _onDescription: function (evt){
      //alert(this._layerInfo.layerObject.url);

      var testUrl = this._layerInfo.layerObject.url;
