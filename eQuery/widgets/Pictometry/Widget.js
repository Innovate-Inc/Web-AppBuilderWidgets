...

{
      templateString: '<div> <br /> <br />Click the "Select" Pictometry button to activate, then click on a point of interest on the map to display Pictometry imagery for this location in a new window.  <br /> <br /> <br /> ' +
            '<input type="button" style="background-color: rgb(125,125,125)!important; background: url(./widgets/PictometryInternal/images/icon.png) no-repeat;"  class="jimu-btn" id="btnPict" value=" &nbsp;&nbsp;&nbsp; Select" data-dojo-attach-event="click:_pictometryClick"> <br /> <br /> <br /></div> ',
